...
public class QuanLyHoaDonDAO {
    ...
    public Boolean add(HoaDon hd) {
        connection = new ConnectionDB();
        Boolean success = connection.sqlUpdate("INSERT INTO hoadon(MaHD,MaNV,MaKH,NgayLap,TongTien) VALUES ('" 
                + hd.getMaHoaDon() + "','" 
                + hd.getMaNhanVien() + "','" 
                + hd.getMaKhachHang() + "','" 
                + hd.getNgayLap() + "','" 
    ...
    public Boolean update(String maHoaDon, String maNhanVien, String maKhachHang, LocalDate ngayLap, float tongTien) {
        HoaDon hd = new HoaDon();
