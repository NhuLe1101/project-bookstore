...
public class QuanLyTaiKhoanDAO {
        ...
        try {
            ...
            if (r != null) {
                while (r.next()) {
                    ...
                    String loaiquyen = r.getString("LoaiQuyen");
                    
                    dstk.add(new TaiKhoan(ten, pass, manv, loaiquyen));
                }
            }
    ...
    public Boolean add(TaiKhoan tk) {
        qltkConnectiion = new ConnectionDB();
        Boolean ok = qltkConnectiion.sqlUpdate("INSERT INTO `taikhoan` (`TenTaiKhoan`, `MatKhau`, `MaNV`, `LoaiQuyen`) VALUES ('"
                + tk.getUsername() + "', '" + tk.getPassword() + "', '" + tk.getMaNV() + "', '" + tk.getLoaiQuyen() + "');");
        qltkConnectiion.closeConnect();
        return ok;
    }
    ...
    public Boolean update(String username, String pass, String maNV, String loaiQuyen) {
        ...
        Boolean ok = qltkConnectiion.sqlUpdate("Update taikhoan Set MatKhau='" + pass + "',MaNV='" + maNV
                + "',LoaiQuyen='" + loaiQuyen + "' where TenTaiKhoan='" + username + "'");
        qltkConnectiion.closeConnect();
        return ok;
    }
