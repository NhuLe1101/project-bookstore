...
public class QuanLyHoaDonBUS {
    ...
    public String[] getHeaders() {
        return new String[]{"Mã hóa đơn", "Mã nhân viên", "Mã khách hàng", "Mã khuyến mãi", "Ngày lập", "Tổng tiền"};
    }
    ...
    public Boolean add(String maHoaDon, String maNhanVien, String maKhachHang, LocalDate ngayNhap, float tongTien) {
        HoaDon hd = new HoaDon(maHoaDon, maNhanVien, maKhachHang, ngayNhap, tongTien);
        return add(hd);
    }

    public Boolean update(String maHoaDon, String maNhanVien, String maKhachHang, LocalDate ngayNhap, float tongTien) {
        HoaDon hd = new HoaDon(maHoaDon, maNhanVien, maKhachHang, ngayNhap, tongTien);
        return update(hd);
    }
