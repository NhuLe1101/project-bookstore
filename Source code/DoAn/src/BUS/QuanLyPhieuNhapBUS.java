...
public class QuanLyPhieuNhapBUS {
    ...
    public Boolean update(String maPN, String maNCC, String maNV, LocalDate ngayNhap, float tongTien) {
        PhieuNhap pn = new PhieuNhap(maPN, maNCC, maNV, ngayNhap, tongTien);
        return update(pn);
    }
    ...
    public boolean add(String maPN, String maNCC, String maNV, LocalDate ngayNhap, float tongTien) {
        PhieuNhap pn = new PhieuNhap(maPN, maNCC, maNV, ngayNhap, tongTien);
        return add(pn);
    }
